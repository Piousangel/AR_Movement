...
//시작 직전에 bake를 하여 고정된 navmesh가 없도록 하는 코드입니다.
public class MapManager : MonoBehaviour
{
	...
	//충돌날 물체에 대해서 bake 전에 지우고 bake 후에 다시 보이게하는 코드입니다.
	//Script 내의 NavMeshComponents 폴더의 스크립트들이 필요합니다.
